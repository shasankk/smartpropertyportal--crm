...
## Problem Statement
To develop a centralized Salesforce CRM system that automates property management, lead tracking, and sales operations for real estate businesses.
...
1. Clone this repository  
   ```bash
   git@github.com:shasankk/smartpropertyportal--crm.git
